# ทำไมพรถึง Burnout และ 3 กฎที่ช่วยให้รอด

> ทำไมบางวันที่พยายามขยันที่สุด กลับรู้สึกล้มเหลวที่สุด? นี่คือชีวิต 20 ปีของพรที่วนลูปแบบนั้น และ 3 กฎที่ทำให้ระบบกลับมารันได้อีกครั้ง
...
พรรู้ว่าตัวเองมี ADHD (สมาธิสั้น) ตั้งแต่อายุ 19 ปีคับ แต่การรู้ชื่อโรคไม่ได้แปลว่ารู้วิธีอยู่กับมัน
